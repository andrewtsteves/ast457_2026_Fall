# ASTR 457 Fall 2026: assignment tracker

Every dated deliverable in one place. **Dates marked (tentative) may move; the syllabus and the
lab notebook header are authoritative when they disagree with this file.** Labs are posted on
...
**Before class Thu Sep 24 (one time):** `conda activate astr457`, then `conda install -c conda-forge "ipykernel=6.31"`, then restart Jupyter. See `INSTALL.txt`.

## Labs

| Lab | Topic | Posted | Due (Wed, Noon) | Status |
|---|---|---|---|---|
...
| review | Regression review test (individual, in class; counts as one lab) | Tue Sep 29 | Wed Sep 30 | in class Sep 29; `lecture/05/review_test_sep29.ipynb` |
...
| 09 | ABC and simulation-based inference | Thu Nov 5 | Wed Nov 11 (tentative) | |
...
Short, written, closed-everything, at the start of class, roughly every other week.
...
- Fall break Nov 21-29: no class Nov 24 and 26, nothing due over break.
- Last day of instruction: Wed Dec 9.
- Colloquia are Tuesdays 3:45 pm in this classroom (Astronomy 134); the ones tied to labs are
  announced on the day's slides.
