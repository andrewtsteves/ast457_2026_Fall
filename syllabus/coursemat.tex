...
\item[] \travelrow{{\bf\headerfont\color{RoyalBlue} Sep 29, Oct 1} \emph{(GN via Zoom Sep 29; guest lecture Padma Venkatraman Oct 1)}\\ Bayes in practice, sampling and Markov Chain Monte Carlo methods (ICVG Ch. 5). {\bf Regression review test in class Sep 29} (individual, counts as one lab; pull request due Wed Sep 30 by Noon).}\smallskip
